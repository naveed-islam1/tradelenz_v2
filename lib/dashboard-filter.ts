...
export const applyFilters = (query: any, filter: any) => {
  ...
  if (filter === "wins") conditions.push({ field: "result", type: "gt", value: 10 });
  if (filter === "losses") conditions.push({ field: "result", type: "lt", value: -10 });
  if (filter === "breakeven") {
    conditions.push({ field: "result", type: "gte", value: -10 });
    conditions.push({ field: "result", type: "lte", value: 10 });
  }
